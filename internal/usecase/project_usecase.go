...
func (u *ProjectUsecase) GetProjectLogsByDeploymentName(ctx context.Context, deploymentName string) (string, error) {
	return pkg.GetLogPodResources(deploymentName)
}
